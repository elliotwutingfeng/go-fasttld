...
var lookoutTests = []extractTest{ // some tests from lookout.net
	...
	// {urlParams: URLParams{URL: "http://ab--cd.urltest.lookout.net"}, expected: &ExtractResult{Scheme: "http://", SubDomain: "ab--cd.urltest", Domain: "lookout", Suffix: "net", RegisteredDomain: "lookout.net"}, description: "Bad double-hyphen in SubDomain"},
	...
	{urlParams: URLParams{URL: "http://foo-.urltest.lookout.net"}, expected: &ExtractResult{Scheme: "http://", SubDomain: "foo-.urltest", Domain: "lookout", Suffix: "net", RegisteredDomain: "lookout.net"}, description: "SubDomain label end with dash"},
