...
var lookoutTests = []extractTest{ // some tests from lookout.net
	...
	{urlParams: URLParams{URL: "http://www.lookout.net\uff1a80.urltest.lookout.net"}, expected: &ExtractResult{Scheme: "http://", SubDomain: "", Domain: "", Suffix: "", RegisteredDomain: ""}, description: "Reject full-width colon"},
	...
	{urlParams: URLParams{URL: "http://www\u2025urltest.lookout.net"}, expected: &ExtractResult{Scheme: "http://"}, description: ""},
	{urlParams: URLParams{URL: "http://xn--0.urltest.lookout.net"}, expected: &ExtractResult{Scheme: "http://", SubDomain: "", Domain: "", Suffix: "", RegisteredDomain: ""}, description: "Invalid Punycode"},
