...
var lookoutTests = []extractTest{ // some tests from lookout.net
	...
	// {urlParams: URLParams{URL: "http:////////user:@urltest.lookout.net?foo"}, expected: &ExtractResult{Scheme: "http://", SubDomain: "", Domain: "lookout", Suffix: "net", RegisteredDomain: "lookout.net"}, description: ""},
	...
	// {urlParams: URLParams{URL: "http://GOO \u3000goo.urltest.lookout.net/"}, expected: &ExtractResult{Scheme: "http://", SubDomain: "", Domain: "lookout", Suffix: "net", RegisteredDomain: "lookout.net"}, description: ""},
	{urlParams: URLParams{URL: "http://GOO\u200b\u2060\ufeffgoo.urltest.lookout.net/"}, expected: &ExtractResult{Scheme: "http://", SubDomain: "GOO\u200b\u2060\ufeffgoo.urltest", Domain: "lookout", Suffix: "net", RegisteredDomain: "lookout.net"}, description: ""},
	// {urlParams: URLParams{URL: "http://Goo%20 goo%7C|.urltest.lookout.net/"}, expected: &ExtractResult{Scheme: "http://", SubDomain: "", Domain: "lookout", Suffix: "net", RegisteredDomain: "lookout.net"}, description: ""},
	...
	{urlParams: URLParams{URL: "http://\u0dc1\u0dca\u200d\u0dbb\u0dd3.com.urltest.lookout.net/"}, expected: &ExtractResult{Scheme: "http://", SubDomain: "\u0dc1\u0dca\u200d\u0dbb\u0dd3.com.urltest", Domain: "lookout", Suffix: "net", RegisteredDomain: "lookout.net"}, description: ""},
	{urlParams: URLParams{URL: "http://\u0dc1\u0dca\u200d\u0dbb\u0dd3.urltest.lookout.net/"}, expected: &ExtractResult{Scheme: "http://", SubDomain: "\u0dc1\u0dca\u200d\u0dbb\u0dd3.urltest", Domain: "lookout", Suffix: "net", RegisteredDomain: "lookout.net"}, description: ""},
