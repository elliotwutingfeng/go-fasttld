...
var lookoutTests = []extractTest{ // some tests from lookout.net
	...
	{urlParams: URLParams{URL: "%68%74%74%70%3a%2f%2f%77%77%77%2e%65%78%61%6d%70%6c%65%2e%63%6f%6d%2f.urltest.lookout.net"}, expected: &ExtractResult{SubDomain: "%68%74%74%70%3a%2f%2f%77%77%77%2e%65%78%61%6d%70%6c%65%2e%63%6f%6d%2f.urltest", Domain: "lookout", Suffix: "net", RegisteredDomain: "lookout.net"}, description: ""},
	{urlParams: URLParams{URL: "http%3a%2f%2f%77%77%77%2e%65%78%61%6d%70%6c%65%2e%63%6f%6d%2f.urltest.lookout.net"}, expected: &ExtractResult{SubDomain: "http%3a%2f%2f%77%77%77%2e%65%78%61%6d%70%6c%65%2e%63%6f%6d%2f.urltest", Domain: "lookout", Suffix: "net", RegisteredDomain: "lookout.net"}, description: ""},
	...
	{urlParams: URLParams{URL: "http://%77%77%77%2e%65%78%61%6d%70%6c%65%2e%63%6f%6d.urltest.lookout.net%3a%38%30"}, expected: &ExtractResult{Scheme: "http://", SubDomain: "%77%77%77%2e%65%78%61%6d%70%6c%65%2e%63%6f%6d.urltest.lookout", Domain: "net%3a%38%30"}, description: ""},
	...
	{urlParams: URLParams{URL: "http://-foo.urltest.lookout.net"}, expected: &ExtractResult{Scheme: "http://"}, description: ""},
	...
	{urlParams: URLParams{URL: "http://[google.com.].urltest.lookout.net"}, expected: &ExtractResult{Scheme: "http://"}, description: ""},
	{urlParams: URLParams{URL: "http://[urltest.lookout.net]/"}, expected: &ExtractResult{Scheme: "http://"}, description: ""},
	{urlParams: URLParams{URL: "http://\u001f.urltest.lookout.net"}, expected: &ExtractResult{Scheme: "http://"}, description: ""},
	...
	{urlParams: URLParams{URL: "http://\u0442(.urltest.lookout.net"}, expected: &ExtractResult{Scheme: "http://"}, description: ""},
	...
	{urlParams: URLParams{URL: "http://urltest.lookout.net\u2a7480/"}, expected: &ExtractResult{Scheme: "http://", SubDomain: "urltest.lookout", Domain: "net\u2a7480", Path: "/"}, description: ""},
	{urlParams: URLParams{URL: "http://urltest.lookout.net\uff0ffoo/"}, expected: &ExtractResult{Scheme: "http://", SubDomain: "urltest.lookout", Domain: "net\uff0ffoo", Path: "/"}, description: ""},
