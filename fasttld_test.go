...
var invalidTests = []extractTest{
	{urlParams: URLParams{URL: "localhost!"}, expected: ExtractResult{}, err: errors.New("idna: disallowed rune U+0021"), description: "localhost + invalid character !"},
	{urlParams: URLParams{URL: "localhost+"}, expected: ExtractResult{}, err: errors.New("idna: disallowed rune U+0020"), description: "localhost + invalid character +"},
	{urlParams: URLParams{URL: "localhost-"}, expected: ExtractResult{Domain: "localhost-", HostType: HostName}, description: "localhost + invalid character - (still accepted)"},
	...
	// {urlParams: URLParams{URL: "http://.\u3002127.0.0.1"}, expected: ExtractResult{Scheme: "http://", HostType: HostName}, err: errs[8], description: "Consecutive label separators before IPv4 address"},
	{urlParams: URLParams{URL: "http://.\u3002[aBcD:ef01:2345:6789:aBcD:ef01:2345:6789]"},
	...
	{urlParams: URLParams{URL: "http://example.com :50"},
		expected: ExtractResult{Scheme: "http://", Port: "50"}, err: errors.New("idna: disallowed rune U+0020"), description: "Spaces between domain and Port/Path",
	},
	{urlParams: URLParams{URL: "http://  127.0.0.1"},
		expected: ExtractResult{Scheme: "http://"}, err: errors.New("idna: disallowed rune U+0020"), description: "Spaces before IPv4 address",
	},
	{urlParams: URLParams{URL: "http://127.0.0.1  :50"},
		expected: ExtractResult{Scheme: "http://", Port: "50"}, err: errors.New("idna: disallowed rune U+0020"), description: "Spaces between IPv4 address and Port/Path",
	},
	{urlParams: URLParams{URL: "http://  [aBcD:ef01:2345:6789:aBcD:ef01:2345:6789]"},
	...
	{urlParams: URLParams{URL: ".\u3002a\uff61fk"}, expected: ExtractResult{Suffix: "a\uff61fk", RegisteredDomain: "\u3002a\uff61fk"}, err: errs[9], description: "TLD only, multiple leading label separators"},
	{urlParams: URLParams{URL: "https://brb\u002ei\u3002am\uff0egoing\uff61to\uff0ebe.\u3002a\uff61fk"}, expected: ExtractResult{Scheme: "https://", SubDomain: "brb\u002ei\u3002am\uff0egoing\uff61to\uff0ebe", Suffix: "a\uff61fk", RegisteredDomain: "\u3002a\uff61fk"}, err: errs[9], description: "Consecutive label separators between Domain and Suffix"},
	{urlParams: URLParams{URL: "https://brb\u002ei\u3002am\uff0egoing\uff61to.\uff0ebe\u3002a\uff61fk"}, expected: ExtractResult{Scheme: "https://", SubDomain: "brb\u002ei\u3002am\uff0egoing\uff61to.", Domain: "be", Suffix: "a\uff61fk", RegisteredDomain: "be\u3002a\uff61fk", HostType: HostName}, description: "Consecutive label separators between SubDomain and Domain (still accepted)"},
	{urlParams: URLParams{URL: "https://brb\u002ei\u3002.am.\uff0egoing\uff61to\uff0ebe\u3002a\uff61fk"}, expected: ExtractResult{Scheme: "https://", SubDomain: "brb\u002ei\u3002.am.\uff0egoing\uff61to", Domain: "be", Suffix: "a\uff61fk", RegisteredDomain: "be\u3002a\uff61fk", HostType: HostName}, description: "Consecutive label separators within SubDomain (still accepted)"},
	...
	{urlParams: URLParams{URL: "http://%78n--0.example.com", ConvertURLToPunyCode: true}, expected: ExtractResult{Scheme: "http://"}, err: errors.New(`idna: invalid label "0"`), description: "Bad percentage encoding"},
	...
	{urlParams: URLParams{URL: "git+ssh://www.!example.com/"}, expected: ExtractResult{Scheme: "git+ssh://", Path: "/"}, err: errors.New("idna: disallowed rune U+0021"), description: "Full git+ssh URL with bad Domain"},
}
...
var lookoutTests = []extractTest{ // some tests from lookout.net
	{urlParams: URLParams{URL: "http://GOO\u200b\u2060\ufeffgoo.urltest.lookout.net"}, expected: ExtractResult{Scheme: "http://", SubDomain: "GOO\u200b\u2060\ufeffgoo.urltest", Domain: "lookout", Suffix: "net", RegisteredDomain: "lookout.net", HostType: HostName}, description: "Invalid chars (still accepted)"},
	{urlParams: URLParams{URL: "http://\u0646\u0627\u0645\u0647\u200c\u0627\u06cc.urltest.lookout.net"}, expected: ExtractResult{Scheme: "http://", SubDomain: "\u0646\u0627\u0645\u0647\u200c\u0627\u06cc.urltest", Domain: "lookout", Suffix: "net", RegisteredDomain: "lookout.net", HostType: HostName}, description: "Invalid chars (still accepted)"},
	{urlParams: URLParams{URL: "http://\u0000\u0dc1\u0dca\u200d\u0dbb\u0dd3.com.urltest.lookout.net"}, expected: ExtractResult{Scheme: "http://"}, err: errors.New("idna: disallowed rune U+0000"), description: "Invalid chars"},
	{urlParams: URLParams{URL: "http://\u0dc1\u0dca\u200d\u0dbb\u0dd3.urltest.lookout.net"}, expected: ExtractResult{Scheme: "http://", SubDomain: "\u0dc1\u0dca\u200d\u0dbb\u0dd3.urltest", Domain: "lookout", Suffix: "net", RegisteredDomain: "lookout.net", HostType: HostName}, description: "Invalid chars (still accepted)"},
	{urlParams: URLParams{URL: "http://look\ufeffout.urltest.lookout.net"}, expected: ExtractResult{Scheme: "http://", SubDomain: "look\ufeffout.urltest", Domain: "lookout", Suffix: "net", RegisteredDomain: "lookout.net", HostType: HostName}, description: "Invalid chars (still accepted)"},
	{urlParams: URLParams{URL: "http://www\u00A0.urltest.lookout.net"}, expected: ExtractResult{Scheme: "http://"}, err: errors.New("idna: disallowed rune U+00A0"), description: "Invalid chars"},
	{urlParams: URLParams{URL: "http://\u1680.urltest.lookout.net"}, expected: ExtractResult{Scheme: "http://"}, err: errors.New("idna: disallowed rune U+1680"), description: "Invalid chars"},
	{urlParams: URLParams{URL: "%68%74%74%70%3a%2f%2f%77%77%77%2e%65%78%61%6d%70%6c%65%2e%63%6f%6d%2f.urltest.lookout.net"}, expected: ExtractResult{}, err: errors.New("idna: disallowed rune U+003A"), description: "Percentage encoded SubDomain"},
	{urlParams: URLParams{URL: "http%3a%2f%2f%77%77%77%2e%65%78%61%6d%70%6c%65%2e%63%6f%6d%2f.urltest.lookout.net"}, expected: ExtractResult{}, err: errors.New("idna: disallowed rune U+003A"), description: "Percentage encoded SubDomain"},
	{urlParams: URLParams{URL: "http://%25.urltest.lookout.net"}, expected: ExtractResult{Scheme: "http://"}, err: errors.New("idna: disallowed rune U+0025"), description: "Percentage encoded SubDomain"},
	...
	{urlParams: URLParams{URL: "http://%77%77%77%2e%65%78%61%6d%70%6c%65%2e%63%6f%6d.urltest.lookout.net%3a%38%30"}, expected: ExtractResult{Scheme: "http://"}, err: errors.New("idna: disallowed rune U+003A"), description: "Percentage encoded SubDomain and Domain"},
	...
	{urlParams: URLParams{URL: "http://%ef%b7%90zyx.urltest.lookout.net"}, expected: ExtractResult{Scheme: "http://"}, err: errors.New("idna: disallowed rune U+FDD0"), description: "Percentage encoded SubDomain"},
	{urlParams: URLParams{URL: "http://%ef%bc%85%ef%bc%90%ef%bc%90.urltest.lookout.net"}, expected: ExtractResult{Scheme: "http://"}, err: errors.New("idna: disallowed rune U+FF05"), description: "Percentage encoded SubDomain"},
	{urlParams: URLParams{URL: "http://%ef%bc%85%ef%bc%94%ef%bc%91.urltest.lookout.net"}, expected: ExtractResult{Scheme: "http://"}, err: errors.New("idna: disallowed rune U+FF05"), description: "Percentage encoded SubDomain"},
	...
	{urlParams: URLParams{URL: "http://-foo.urltest.lookout.net"}, expected: ExtractResult{Scheme: "http://", SubDomain: "-foo.urltest", Domain: "lookout", Suffix: "net", RegisteredDomain: "lookout.net", HostType: HostName}, description: "Start with dash"},
	...
	{urlParams: URLParams{URL: "http://192.168.0.1 hello.urltest.lookout.net"}, expected: ExtractResult{Scheme: "http://"}, err: errors.New("idna: disallowed rune U+0020"), description: "Space in SubDomain"},
	...
	{urlParams: URLParams{URL: "http://GOO \u3000goo.urltest.lookout.net"}, expected: ExtractResult{Scheme: "http://"}, err: errors.New("idna: disallowed rune U+0020"), description: "Space in SubDomain"},
	{urlParams: URLParams{URL: "http://Goo%20 goo%7C|.urltest.lookout.net"}, expected: ExtractResult{Scheme: "http://"}, err: errors.New("idna: disallowed rune U+0020"), description: "Space in SubDomain"},
	...
	{urlParams: URLParams{URL: "http://\u001f.urltest.lookout.net"}, expected: ExtractResult{Scheme: "http://"}, err: errors.New("idna: disallowed rune U+001F"), description: "Control Character in SubDomain"},
	{urlParams: URLParams{URL: "http://\u0378.urltest.lookout.net"}, expected: ExtractResult{Scheme: "http://"}, err: errors.New("idna: disallowed rune U+0378"), description: "Unicode U+0378"},
	...
	{urlParams: URLParams{URL: "http://\u0442(.urltest.lookout.net"}, expected: ExtractResult{Scheme: "http://"}, err: errors.New("idna: disallowed rune U+0028"), description: "Parenthesis in SubDomain"},
	{urlParams: URLParams{URL: "http://\u04c0.urltest.lookout.net"}, expected: ExtractResult{Scheme: "http://"}, err: errors.New("idna: disallowed rune U+04C0"), description: "Unicode in SubDomain"},
	{urlParams: URLParams{URL: "http://\u06dd.urltest.lookout.net"}, expected: ExtractResult{Scheme: "http://"}, err: errors.New("idna: disallowed rune U+06DD"), description: "Unicode in SubDomain"},
	...
	{urlParams: URLParams{URL: "http://\u180e.urltest.lookout.net"}, expected: ExtractResult{Scheme: "http://"}, err: errors.New("idna: disallowed rune U+180E"), description: "Unicode in SubDomain"},
	...
	{urlParams: URLParams{URL: "http://\u2183.urltest.lookout.net"}, expected: ExtractResult{Scheme: "http://"}, err: errors.New("idna: disallowed rune U+2183"), description: "Unicode in SubDomain"},
	...
	{urlParams: URLParams{URL: "http://\ufdd0zyx.urltest.lookout.net"}, expected: ExtractResult{Scheme: "http://"}, err: errors.New("idna: disallowed rune U+FDD0"), description: "Unicode in SubDomain"},
	{urlParams: URLParams{URL: "http://\uff05\uff10\uff10.urltest.lookout.net"}, expected: ExtractResult{Scheme: "http://"}, err: errors.New("idna: disallowed rune U+FF05"), description: "Unicode in SubDomain"},
	{urlParams: URLParams{URL: "http://\uff05\uff14\uff11.urltest.lookout.net"}, expected: ExtractResult{Scheme: "http://"}, err: errors.New("idna: disallowed rune U+FF05"), description: "Unicode in SubDomain"},
	...
	{urlParams: URLParams{URL: "http://hello%00.urltest.lookout.net"}, expected: ExtractResult{Scheme: "http://"}, err: errors.New("idna: disallowed rune U+0000"), description: "Percentage encoded SubDomain"},
	...
	{urlParams: URLParams{URL: "http://look\u05beout.urltest.lookout.net"}, expected: ExtractResult{Scheme: "http://"}, err: errors.New(`idna: invalid label "look־out.urltest.lookout.net"`), description: "Unicode in SubDomain"},
	{urlParams: URLParams{URL: "http://look\u202eout.urltest.lookout.net"}, expected: ExtractResult{Scheme: "http://"}, err: errors.New("idna: disallowed rune U+202E"), description: "Unicode in SubDomain"},
	...
	{urlParams: URLParams{URL: "http://look\u206bout.urltest.lookout.net"}, expected: ExtractResult{Scheme: "http://"}, err: errors.New("idna: disallowed rune U+206B"), description: "Unicode in SubDomain"},
	{urlParams: URLParams{URL: "http://look\u2ff0out.urltest.lookout.net"}, expected: ExtractResult{Scheme: "http://"}, err: errors.New("idna: disallowed rune U+2FF0"), description: "Unicode in SubDomain"},
	{urlParams: URLParams{URL: "http://look\ufffaout.urltest.lookout.net"}, expected: ExtractResult{Scheme: "http://"}, err: errors.New("idna: disallowed rune U+FFFA"), description: "Unicode in SubDomain"},
	...
	{urlParams: URLParams{URL: "http://urltest.lookout.net\u2a7480/"}, expected: ExtractResult{Scheme: "http://", Path: "/"}, err: errors.New("idna: disallowed rune U+2A74"), description: "Unicode in Domain"},
	{urlParams: URLParams{URL: "http://urltest.lookout.net\uff0ffoo/"}, expected: ExtractResult{Scheme: "http://", Path: "/"}, err: errors.New("idna: disallowed rune U+FF0F"), description: "Unicode in Domain"},
	...
	{urlParams: URLParams{URL: "http://www.lookout.net\uff1a80.urltest.lookout.net"}, expected: ExtractResult{Scheme: "http://"}, err: errors.New("idna: disallowed rune U+FF1A"), description: "Reject full-width colon"},
	...
	{urlParams: URLParams{URL: "http://www\u2025urltest.lookout.net"}, expected: ExtractResult{Scheme: "http://"}, err: errors.New("idna: disallowed rune U+2025"), description: "Invalid Character"},
